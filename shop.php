...
$dataProduk = mysqli_query($db,"SELECT * FROM produk ORDER BY id ASC");
...
<?php require_once("./header.php");?>
    ...
    <section class="shop spad">
        <div class="container">
                                    ...
                                    <div id="collapseThree" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__price">
                                                <ul>
                                                    <li><a href="#">1 - 20.000</a></li>
                                                    <li><a href="#">20.001 - 45.000</a></li>
                                                    <li><a href="#">45.001 - 90.000</a></li>
                                                    <li><a href="#">90.001 - 150.000</a></li>
                                                    <li><a href="#">150.000 - 330.000</a></li>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__right">
                                    ...
                                    <select>
                                        ...
                                        <option value="">150.001 - 999.000</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                    <?php if(mysqli_num_rows($dataProduk)>0){ 
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="product__item__text">
                                ...
                                <input type="hidden" name="product_price" value="<?= $row['harga'];?>"> 
                                    ...
                                    <input type="submit" a href="" class="add-cart" name="add_to_cart" + Tambah ke keranjang>
                                </form>
                                    <div class="rating">
